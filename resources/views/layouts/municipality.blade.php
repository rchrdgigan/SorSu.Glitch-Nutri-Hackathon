...
<body class="nav-md">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{url('/home')}}" class="site_title"><i class="fa fa-users"></i> <span>Municipality</span></a>
            </div>

            <div class="clearfix"></div>
            
            <!-- menu profile quick info -->
            @include('layouts.municipality.menu-prof-info')
            <!-- /menu profile quick info -->

            <br />

            <!-- sidebar menu -->
            @include('layouts.municipality.side-bar')
            <!-- /sidebar menu -->
         ...
         <!-- top navigation -->
         @include('layouts.municipality.top-nav-bar')
        <!-- /top navigation -->
        ...
        <!-- footer content -->
        @include('layouts.municipality.footer')
        <!-- /footer content -->
