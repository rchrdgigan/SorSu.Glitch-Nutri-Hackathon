								...
								<div class="x_content">
									...
									<form action="{{route('farmer.create')}}" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select class="form-control @error('municipality_id') is-invalid @enderror" name="municipality_id">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tr> 
                                        ...
                                        @endforeach
                                        <td>
                                            <a href="{{route('farmer.edit', $farms->id)}}" class="btn btn-success btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i></a>
